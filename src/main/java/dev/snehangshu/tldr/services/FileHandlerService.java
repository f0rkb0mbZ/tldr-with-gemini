...
public class FileHandlerService {
    ...
    public String processFile(MultipartFile doc, float temperature, int maxTokens) throws IOException {
        ...
        if (ObjectUtils.isEmpty(chatResponse.getCandidates().getFirst().getContent())) {
            return "TL;DR failed with reason: " + chatResponse.getCandidates().getFirst().getFinishReason();
        } else {
